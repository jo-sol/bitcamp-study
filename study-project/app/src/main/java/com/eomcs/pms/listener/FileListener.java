...
public class FileListener implements ApplicationContextListener {
  ...
  private <E> void loadObjects( // 제약 조건을 여기에 걸기
    ...
    try (BufferedReader in = new BufferedReader(
      ...
      // JSON 데이터로 읽어 온 목록을 파라미터로 받은 List에 저장한다.
  ...
  private void saveObjects(String filepath, List<?> list) { // List <?> 어떤 타입이든 상관없다
