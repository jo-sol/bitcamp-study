...
public class App3 {
  ...
  public static void main(String[] args) {
    ...
    System.out.print("번호? ");
    int no = Integer.parseInt(keyboardScan.nextLine()); // Integer라는 설계도의 parseInt라는 도구를 만나 문자열로 출력
    // 
    ...
    System.out.print("> ");
    int status = Integer.valueOf(keyboardScan.nextLine()); // Integer라는 설계도의 valueOf라는 도구를 만나 문자열로 출력
