...
import com.eomcs.pms02.domain.Board;
...
//    String label = String.format("제목:(%s)?", board.title); // String 클래스의 format은 printf와 비슷하지만
//    printf는 출력하는 거라면 format은 board.title을 받아서 제목:(%s)?에 넣고 그 문자열을 리턴한다
