...
public class TaskHandler {
  ...
  // MemberHandler의 클래스를 바로 쓸 뿐이지 MemberHandler의 인스턴스를 사용하지 않기 때문에 없애도 됨
  ...
  public void update() {
    ...
    Member owner = MemberHandler.promptMember( // static 메서드는 클래스 이름으로 호출!!
