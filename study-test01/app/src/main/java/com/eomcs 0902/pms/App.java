package com.eomcs.pms;   // 리팩토링 >> 메뉴 생성 코드 정리
...
public class App {
  ...
  Menu createMainMenu() {
    ...
    mainMenuGroup.add(new MenuItem("내 정보", Menu.ENABLE_LOGIN, "/auth/userinfo"));
