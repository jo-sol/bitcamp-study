...
public class Exam0510 {
  public static void main(String[] args) {
    ...
    // => 선언하지 않으면 문법 오류!
    /* 
    (age > 18) ? System.out.println("성인이다.") : System.out.println("미성년자이다."); // 왼쪽에 할당문이 없다
     */
    ...
    String message = (age > 18) ? "성년" : "미성년"; // (age > 18)이 참이면 "성년"이 message에 저장되고, 거짓이면 "미성년"이 저장된다
    System.out.printf("나이 %d는(은) %s이다.\n", age, message);
  }
}

// 표현식(expression)?  ★영어 기억하기(자주 쓰임)★
