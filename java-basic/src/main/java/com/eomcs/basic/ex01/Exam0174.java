...
public class Exam0174 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // 자동차 복제
    // => Car의 clone()에서 **Engine 객체도 복제**할 것이다.
    Car car2 = car.clone();

    System.out.println(car == car2);
    System.out.println(car);
    System.out.println(car2);
    System.out.println(car.engine == car2.engine); // Engine 객체도 복제해서 false

    // car의 엔진과 car2의 엔진이 다른 엔진인지 확인해보자!
    car.engine.cc = 2000; // => car의 engine은 2000으로 바뀌었으나
    System.out.println(car2.engine.cc); // car2의 engine은 그대로 3000을 가리킴
