// Object 클래스 - clone() : shallow copy // 녹음 134
...
public class Exam0173 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Car car = new Car("비트자동차", "비트비트", engine); // (1) 그림

    // 자동차 복제
    Car car2 = car.clone(); // (2) 그림

    System.out.println(car == car2); // false
    System.out.println(car);
    System.out.println(car2);
    System.out.println(car.engine == car2.engine); // true 주소가 같냐?

    // car와 car2의 엔진이 같다는 것은,
    // 같은 engine의 객체 주소라는 뜻이다.
    car.engine.cc = 2000; // (3) 빨강
