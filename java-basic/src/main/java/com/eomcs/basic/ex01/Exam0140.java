// Object 클래스 - hashCode()에 대하여 // 녹음 131&132
...
public class Exam0140 {
  ...
  public static void main(String[] args) {
    ...
    // toHexString: 10진수를 16진수로 바꿔서 문자열로 리턴해 주는 코드 사용
    // ***녹음 131번 28분 정도부터 다시 듣기
    // 인스턴스가 다르면 해시 값도 달라진다 ***
    System.out.println(Integer.toHexString(obj1.hashCode()));
    System.out.println(Integer.toHexString(obj2.hashCode()));

    // ***
    // println: String이 아닌 어떤 객체 주소가 넘어온다면
    // 그 인스턴스 주소에 대해 내부적으로 toString()이라는 메서드를 호출하여 그 값을 리턴한다
    // 인스턴스가 다르면 해시 값도 달라진다 ***
    ...
    //      예2) 파일 다운로드 사이트에서 제공하는 해시 값. (ex. tomcat.apache.org/)
    //      예3) 파일 공유사이트에서 파일을 구분할 때 해시 값 사용. 
    //          사용자가 파일 이름, 확장자를 변경하더라도 데이터만 바꾸지 않는다면 
    //          파일의 해시 값은 같다. 
    // - 해시 알고리즘
    //   => SHA, MD4, MD5, PGP, CRC 등 
  }
