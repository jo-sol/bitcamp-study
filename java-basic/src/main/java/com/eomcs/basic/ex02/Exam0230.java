...
public class Exam0230 {
  ...
  public static void main(String[] args) {
    ...
    // 설명:
    // => new 연산자를 통해 Integer 객체를 생성하면 **Heap에 인스턴스(Integer 객체)를 생성한다.**
    // => 그래서 같은 값이더라도 다른 인스턴스가 생성된다. (new String 예시 떠올리면 됨)
    ...
    //    자주 사용되는 수이기 때문에
    //    String 리터럴처럼 중복하지 않고 상수 풀에 Integer 객체를 생성한다.
    // => 메모리를 효율적으로 사용하기 위해
    ...
    // 하단의 Integer 객체 전부 heap 메모리에 생성된다.
    Integer obj7 = 128;
    Integer obj8 = 128;
    Integer obj9 = 128;
    ...
    // wrapper 클래스도 String 클래스처럼 Object의 equals()를 오버라이딩 해서 받는다
    ...
    // - 더 좋은 방법은 auto-unboxing 하여 primitive type의 값으로 바꾼 후에 == 연산자로 비교하라.
