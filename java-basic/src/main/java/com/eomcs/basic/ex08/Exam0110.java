...
public class Exam0110 {
  public static void main(String[] args) {
    ...
    // put(key,value) : 맵에 값 저장하기 (위치를 가리킬 때 사용하는 값: key, value 객체)
    ...
    map.put("s02", new Member("윤봉길", 30)); // "임꺽정"은 가비지가 된다.
...
// ** 자바에서 메서드를 호출할 때(new) 객체를 저장하는 방법은 없다.
// ** 전달하는 방법 역시 없다.
// ** 그동안 객체를 리턴하고 저장하고 전달했다고 생각한다면,
// ** 주고받았던 건 객체의 주소이다!! 객체가 아니다!!
