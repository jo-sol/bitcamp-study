...
public class Test01_1 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    BufferedOutputStream out1 = new BufferedOutputStream(out0); // 출력 속도 향상시키기 > 데코레이터
    DataOutputStream out = new DataOutputStream(out1); // 데코레이터 패턴
    ...
    out.flush(); 
    // => 버퍼에 남아있는 것까지 깔끔하게 출력하고 싶을 때 호출.
    // => 습관적으로 호출하는 게 좋다.
    // close()를 호출할 때는 얘를 호출하지 않아도 되지만, 혹시 모를 상황에 대비해 호출
