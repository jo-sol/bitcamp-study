...
public class Member implements java.io.Serializable {
  ...
  // serialVersionUID를 직접 설정하고 그 버전이 계속 같다면
  // 같은 클래스로 간주하여 필드를 추가해도 오류가 나지 않는다!

  String name;

  //Exam0420의 세 번째 테스트를 실행할 때 주석으로 막아라!
  int age; // => 값은 있으나 버전에서 사용하지 않게 된다면 버려 버린다.

  boolean gender; // true(여자), false(남자)

  // Exam0420의 두 번째 테스트를 실행할 때 주석을 풀라!
  // => serialVersionUID를 직접 설정한 뒤
  //  String tel; // => 값을 넣지 않았기 때문에 null 값으로 출력
