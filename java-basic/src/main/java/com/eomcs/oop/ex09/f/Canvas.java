package com.eomcs.oop.ex09.f; // 녹음 148
...
public class Canvas {
  ...
  //    훨신 유연한 코딩을 가능하게 한다.
  Pen tool;
  // tool에는 Pen의 역할로써 작동하는 객체라면 어떤 것이든 담을 수 있다.
  //
  // 만약 Pen tool이 아니라 Monami tool이거나 Zebra tool로 한정한다면,
  // Monami / Zebra 또는 Monami / Zebra의 서브 클래스만 담을 수 있음
