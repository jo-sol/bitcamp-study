...
public class Exam0215 extends com.eomcs.oop.ex08.b.sub.Y {
  ...
  static void m1(X obj) {
    // obj.privateVar = 100; // 접근 불가! X만이 접근 가능!
  ...
  static void m2(com.eomcs.oop.ex08.b.sub.Y obj) {
    ...
    // obj.protectedVar = 100; // 접근 불가! Exam0215가 상속 받아 만든 변수가 아님.
    obj.publicVar = 100;
  } 

  // 서브 클래스의 객체를 파라미터로 받는 경우
  static void m3(com.eomcs.oop.ex08.b.Exam0215 obj) {
    ...
    // obj.privateVar = 100; // 접근 불가! Y 설계도에 따라 만들어짐
    // obj.defaultVar = 100; // 접근 불가! 
    obj.protectedVar = 100; // OK! Y 클래스 설계도에 따라 만든 변수이지만, Y 클래스를 상속 받아 만든 변수다. **
    obj.publicVar = 100;
  }
