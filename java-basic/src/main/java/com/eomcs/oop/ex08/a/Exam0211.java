...
class Score2 {
  ...
  //
  private int sum; // 직접 접근하여 값을 바꾸지 못하도록 private으로 막아 버렸음
  private float aver;
  ...
  // => 그리고 이런 getter는 공개 모드(public / 써야 하니까)로 설정한다.
  //
  public int getSum() {
    return this.sum;
  }
...
public class Exam0211 {
  ...
  } // private로 막혀 있기 때문에 직접 접근할 수는 없지만 getSum()이나 getAver()를 통해 조회할 수는 있다!!
}
