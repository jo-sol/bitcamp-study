// 캡슐화(encapsulation) 접근 범위 테스트 - 서브 클래스의 멤버가 접근할 수 있는 범위 II
...
public class Exam0214 extends com.eomcs.oop.ex08.b.sub.Y {
  ...
  public static void main(String[] args) {
    ...
    //    obj.privateVar = 100; // 접근 불가! 오직 그 클래스에서만 접근 가능
    //    obj.defaultVar = 100; // 접근 불가! 같은 패키지만 접근 가능.

    obj.protectedVar = 100; // OK! Exam0210은 Y의 자식 클래스이며,
