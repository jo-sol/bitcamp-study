...
// 생성자란?
// 인스턴스(= 값을 저장할 변수들의 묶음 / 메서드 없음)를 생성한 후
// 그 인스턴스를 제대로 쓸 수 있도록 유효값으로 초기화 시켜 주는 것
public class Exam0111 {

  public static void main(String[] args) throws Exception {
    // 생성자를 호출하여 문자열 인스턴스를 초기화시킨다.

    // => 문자열 리터럴(상수값)을 사용하여 String 인스턴스를 초기화시키기.
    String s1 = new String("Hello"); // String(스트링 리터럴을 받는) 생성자를 호출하여 인스턴스 초기화
    ...
    String s3 = new String(bytes); // String(byte[]) 생성자를 호출하여 인스턴스 변수를 초기화
