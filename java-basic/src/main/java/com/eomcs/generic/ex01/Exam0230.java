...
// Exam0130과 Exam0230의 다른 점:
// Exam0130: What이 무슨 타입인지는 메서드가 호출될 때 결정하겠습니다 => 메서드에서 사용하는 경우를 보여 줌
// 특정 타입을 아직 결정하지 않았다 -> 리턴타입 앞에 선언함 (=static <What>)
// Exam0230: 클래스 전체에서 사용되는 경우를 보여 줌 (클래스 선언부에 적어 줌 = class Box<T>
...
public class Exam0230 {
  ...
  //
  static class Box<T> { // <T>를 빼면 하단의 T는 클래스 이름 아니면 인스턴스 이름으로 생각함
