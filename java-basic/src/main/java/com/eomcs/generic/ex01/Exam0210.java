...
// => 다형적 변수를 이용해 하나의 박스로 만들었음 Object 이용 =>  
...
class MemberBox {
  ...
  public void set(Member value) { //set 메서드의 파라미터 타입: Member
    this.value = value;
  }
...
public class Exam0210 {
  ...
  public static void main(String[] args) {
    ...
    box3.set(100); // auto-boxing ==> 컴파일러가 box3.set(Integer.valueOf(100)) 문장으로 변경된다.
    int i = box3.get(); // auto-unboxing ==> 컴파일러가 box3.get().intValue() 문장으로 변경
    System.out.println(i);

    // ***JVM은 스스로 인공지능적인 일을 하지 못한다!!
    // ***주어진 명령어를 위에서 아래로 순서대로 실행할 뿐이다
    // ***auto-boxing과 auto-unboxing은 컴파일할 때 컴파일러가 바꾸는 것이다!!
